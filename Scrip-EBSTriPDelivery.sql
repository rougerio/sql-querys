...
select trip_id ,tp_plan_name ,vehicle_organization_id org_id,organization_code org_code, 
        vendor_name, freight_code ,scac_code, sum(delivery_id_count) num_del, 
...
from (
        ...
        and wt.tp_plan_name like 'MX%'
        and wt.creation_date > TO_DATE('2025-11-13','YYYY-MM-DD')
        and h.organization_code in ('MXC','MTY','GDL')

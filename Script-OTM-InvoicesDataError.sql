...
SELECT 
    ...
    I.INVOICE_NUMBER,  
    I.INV_SERVPROV_GID,  
    SERV2.LOCATION_NAME AS INV_SERVPROV,  
    I.SERVPROV_GID, 
    SERV1.LOCATION_NAME AS SHIPMENT_SERVPROV, 
    I.SERVPROV_ALIAS_VALUE, 
    I.COST, 
    I.INVOICE_REFNUM_QUAL_GID, 
    I.INV_SHIPMENT_GID, 
    I.CARRIER_SHORTNAME, 
    I.ORIG_LOCATION_GID, 
    I.INVOICE_SUMMARY, 
    I.INVOICE_NOTE, 
    SS2.STOP_NUM, 
    L.LOCATION_GID AS DEST_LOCATION_GID 
FROM ( 
    ...
    SHIPMENT_STOP SS2 ON SS2.SHIPMENT_GID = I.INV_SHIPMENT_GID AND SS2.STOP_NUM > 1 INNER JOIN 
    LOCATION L ON L.LOCATION_GID = SS2.LOCATION_GID INNER JOIN
    LOCATION SERV1 ON SERV1.LOCATION_GID = I.SERVPROV_GID INNER JOIN
    LOCATION SERV2 ON SERV2.LOCATION_GID = I.INV_SERVPROV_GID 
    ORDER BY I.INV_SHIPMENT_GID 
;
...
/*
40076720,40076719,40076723,40076724,40076725


MX5001000343,MX5001000342,MX5001000334,MX5001000335,MX5001000336
*/
